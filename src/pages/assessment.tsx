...
function WaterGlass({ index, selectedCount, onTap }: { index: number; selectedCount: number; onTap: () => void }) {
  ...
  return (
    <motion.button whileTap={{ scale: 0.9 }} onClick={onTap} className="flex flex-col items-center gap-1">
      {/* Added WebkitMaskImage to fix iOS border-radius bleeding during animation */}
      <div 
      ...
      >
        {/* Changed from animating height to animating scaleY (Hardware Accelerated for Mobile) */}
        <motion.div
...
export default function Assessment() {
  ...
  return (
    <Page className="p-6 pt-12 pb-6 bg-white overflow-hidden">
      {/* PAGE ENTRANCE ANIMATION: Smooths out the jump from the welcome screen */}
      <motion.div 
